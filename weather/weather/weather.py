...
def getHistoricWeatherData(startYear, endYear):
...
def refineForecastedData(forecasted_weather_df_raw, forecasted_columns_of_interest):
...
def getWeatherForecast(airport_code):
    ...
    try:
        ...
        return refineForecastedData(forecasted_weather_df, forecasted_columns_of_interest)

    except Exception as e:
        print(e)

if (__name__ == '__main__'):
    getHistoricWeatherData(2022, 2023)